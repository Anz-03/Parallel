...
constexpr float filter[FILTERSIZE][FILTERSIZE] = { // [Linear Filter Only]
    {1.0 / 9, 1.0 / 9, 1.0 / 9},
    {1.0 / 9, 1.0 / 9, 1.0 / 9},
    {1.0 / 9, 1.0 / 9, 1.0 / 9}};
constexpr float SIGMA_D = 1.7;  // [Bilateral Filter Only] spatial stddev
constexpr float SIGMA_R = 50.0; // [Bilateral Filter Only] intensity stddev
